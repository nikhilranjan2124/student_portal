...
.dropdown:hover .dropbtn {background-color: #3e8e41;}
  ...
  <form method="post" action="final_academics_faculty.php">
    <h2 class="mt-0"><b><u>Update Student's Academics Details</u></b></h2>
    <h4>Choose Branch</h4>
    ...
    <footer class=" footer  text-center text-info" style="height:40px"><u> Contact Us</u>(9354678256) @ <u>copyrights</u> reserved</footer>
    <!-- Optional JavaScript -->
